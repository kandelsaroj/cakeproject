...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2 style="background-color:#490206; color:white;">Popular Cakes<span> For You</span></h2>
...
<div class="recent-Cake-list"  style="background-color:#490206;">
...
<div class="Cake-title-m" style="background-color:#490206;">
<h4><a style="color:white;" href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['productName']);?></a></h4>

<span class="price"  style="color:white;">Rs <?php echo htmlentities($row['productPrice']);?> <s>  Rs <?php echo htmlentities($row['productPriceBeforeDiscount']);?></s></span>
